...
exports.numberToBanglaWords = void 0;
 ...
 * ```
 */
function numberToBanglaWords(inputNumber) {
    ...
    for (let partIndex = integerPart.length || 0; partIndex > 0; partIndex -= 7) {
        let paddedStr = "0000000" + (integerPart || "").substring(partIndex - 7, partIndex);
...
exports.numberToBanglaWords = numberToBanglaWords;
